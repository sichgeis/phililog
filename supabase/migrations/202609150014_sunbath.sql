...
alter table public.feedings add constraint feedings_kind_check check (kind in ('bottle', 'breast', 'diaper', 'weight', 'temperature', 'sunbath'));
...
alter table public.feedings add constraint feeding_details check (
 ...
 or (kind = 'sunbath' and temperature_c is null and weight_g is null and amount_ml is null and side is null and started_at is null and milk_type is null and urine is null and stool is null and held_success is null)
);
