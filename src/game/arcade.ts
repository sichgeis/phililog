...
interface Options { container: HTMLElement; client: SupabaseClient; account: string; onExit(): void; exitLabel?: string; api?: GameApi }
...
export function mountGame({ container, client, account, onExit, exitLabel = '← Zum Logbuch', api = createApi(client) }: Options): GameController {
